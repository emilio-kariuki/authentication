  ...
  Widget build(BuildContext context) {
    return Container(
      child: GestureDetector(
        onTap: func,
        child: BuildButton(color: kTextColor, child: Center(child: Text(action,style: GoogleFonts.robotoCondensed(fontSize:22.1,color: kprimaryColor,fontWeight: FontWeight.bold)))),
      ),
    );
  }
}
